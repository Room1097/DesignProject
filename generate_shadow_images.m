function shadow_images = generate_shadow_images(qx, qy, n, max_np, prime)
    % Input:
    ...
    for i = max_np + 1:max_np + n
        shadow_images{i - max_np} = zeros(23, 23); % Initialize a 23x23 matrix
        row = 1;
        col = 1;
        ...
        for j = 0:255
            ...
            qxj = mod(round(vpa(subs(qx{j+1}, z, i))), prime);
            qyj = mod(round(vpa(subs(qy{j+1}, z, i))), prime);
